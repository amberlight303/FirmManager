...
<firmManager:layout activeMenuItem="menu-admin" title="Users">
    <div class="content-inner">
        <div class="search-wrapper">
            <form:form modelAttribute="user" action="/admin/users/find" method="get" class="form-horizontal"
        ...
        <a href="/admin/registration" class="btn btn-default btn-center">Registration</a>
                ...
                <tbody>
                    <c:forEach items="${users}" var="user">
                        <tr>
                            ...
                            <td>
                                <a href="/users/${user.id}"><c:out value="${user.username}"/></a>
                            </td>
                                <td>
                            ...
                            <td>
                                <c:if test="${user.employee != null}">
                                    <a href="/employees/${user.employee.id}">
